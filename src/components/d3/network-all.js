...
let circlesTimer, startCirclesTime=0;

const showCirclesTimeSince = (startCirclesTime) => {
  var currentTime = new Date().getTime();
  var runtime = currentTime - startCirclesTime;
...
const startCirclesTimer = () => {
  ...
  circlesTimer = setInterval(function() {
...
let linksTimer, startLinksTime=0;

const showLinksTimeSince = (startLinksTime) => {
  var currentTime = new Date().getTime();
  var runtime = currentTime - startLinksTime;
...
class NetworkGraph extends Component {
  ...
  async drawGraph() {
    ...
    await drawLinks(g, links, BATCH_SIZE, this.state.edgesType, this.state.edgesLabels);
  ...
  render() {
    ...
    return (
      <div>
        <div>
          Nodes: <span id="circles-time"></span> | Links: <span id="links-time"></span>
        </div>
