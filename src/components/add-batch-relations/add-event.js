      ...
      <Modal isOpen={this.props.visible} toggle={()=>this.toggleModal('addEventModal')} className={this.props.className}>
        ...
        <ModalBody>
          ...
          <FormGroup className="autocomplete-search">
            <Input type="text" name="searchItem" placeholder="Search event label..." value={this.state.searchItem} onChange={this.handleChange}/>
            <div className="close-icon" onClick={()=>this.clearSearchEventsInput()}><i className="fa fa-times" /></div>
          </FormGroup>
          <FormGroup className="autocomplete-search">
