...
function Menu() {
  ...
  const [loadingArticleCategories, setLoadingArticleCategories] =
    useState(true);
  ...
  const [deleteMenuItemModalVisible, setDeleteMenuItemModalVisible] =
    useState(false);
  ...
  const menuErrorClass = menuErrorVisible ? '' : ' hidden';
  const menuErrorHTML = (
